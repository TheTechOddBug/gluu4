...
public enum Validations {EMAIL, PHONE, PHOTO, COUNTRY, LOCALE, TIMEZONE;
    ...
    //See https://github.com/GluuFederation/scim/issues/14
    ...
    public static boolean apply(Validations validation, Object value){
        ...
        switch (validation){
            ...
            case PHONE:
                ...
                handle. More info at https://help.gluu.org/identity-management/5577/scim-address-validator-configurable-validators
                 */
                break;
            case PHOTO:
