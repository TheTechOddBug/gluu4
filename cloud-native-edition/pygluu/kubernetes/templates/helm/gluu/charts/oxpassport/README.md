...
![Version: 1.8.43](https://img.shields.io/badge/Version-1.8.43-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 4.5.8](https://img.shields.io/badge/AppVersion-4.5.8-informational?style=flat-square)
...
| image.tag | string | `"4.5.8_dev"` | Image  tag to use for deploying. |
| lifecycle | object | `{}` |  |
