...
| casa.image.tag | string | `"4.5.15-1"` | Image  tag to use for deploying. |
...
| cleanup | object | `{"additionalAnnotations":{},"additionalLabels":{},"customCommand":[],"customScripts":[],"dnsConfig":{},"dnsPolicy":"","image":{"pullPolicy":"IfNotPresent","pullSecrets":[],"repository":"gluufederation/cloudtools","tag":"4.5.15-1"},"interval":60,"lifecycle":{},"limit":1000,"nodeSelector":{},"resources":{"limits":{"cpu":"300m","memory":"300Mi"},"requests":{"cpu":"300m","memory":"300Mi"}},"tolerations":[],"usrEnvs":{"normal":{},"secret":{}},"volumeMounts":[],"volumes":[]}` | Cleanup expired entries in persistence |
...
| cleanup.image.tag | string | `"4.5.15-1"` | Image  tag to use for deploying. |
...
| config.image.tag | string | `"4.5.15-1"` | Image  tag to use for deploying. |
...
| cr-rotate | object | `{"additionalAnnotations":{},"additionalLabels":{},"affinity":{},"dnsConfig":{},"dnsPolicy":"","image":{"pullPolicy":"IfNotPresent","pullSecrets":[],"repository":"gluufederation/cr-rotate","tag":"4.5.15-1"},"lifecycle":{},"nodeSelector":{},"resources":{"limits":{"cpu":"200m","memory":"200Mi"},"requests":{"cpu":"200m","memory":"200Mi"}},"service":{"crRotateServiceName":"cr-rotate","name":"http-cr-rotate","port":8084},"tolerations":[],"usrEnvs":{"normal":{},"secret":{}},"volumeMounts":[],"volumes":[]}` | CacheRefreshRotation is a special container to monitor cache refresh on oxTrust containers. This may be depreciated. |
...
| cr-rotate.image.tag | string | `"4.5.15-1"` | Image  tag to use for deploying. |
...
| fido2.image.tag | string | `"4.5.15-1"` | Image  tag to use for deploying. |
...
| global.upgrade.image.tag | string | `"4.5.15-1"` | Image  tag to use for deploying. |
...
| jackrabbit.image.tag | string | `"4.5.15-1"` | Image  tag to use for deploying. |
...
| opendj.image.tag | string | `"4.5.15-1"` | Image  tag to use for deploying. |
...
| oxauth-key-rotation.image.tag | string | `"4.5.15-1"` | Image  tag to use for deploying. |
...
| oxauth.image.tag | string | `"4.5.15-1"` | Image  tag to use for deploying. |
...
| oxpassport.image.tag | string | `"4.5.15-1"` | Image  tag to use for deploying. |
...
| oxshibboleth.image.tag | string | `"4.5.15-1"` | Image  tag to use for deploying. |
...
| oxtrust.image.tag | string | `"4.5.15-1"` | Image  tag to use for deploying. |
...
| persistence | object | `{"additionalAnnotations":{},"additionalLabels":{},"affinity":{},"customScripts":[],"dnsConfig":{},"dnsPolicy":"","image":{"pullPolicy":"IfNotPresent","pullSecrets":[],"repository":"gluufederation/persistence","tag":"4.5.15-1"},"lifecycle":{},"nodeSelector":{},"resources":{"limits":{"cpu":"300m","memory":"300Mi"},"requests":{"cpu":"300m","memory":"300Mi"}},"tolerations":[],"usrEnvs":{"normal":{},"secret":{}},"volumeMounts":[],"volumes":[]}` | Job to generate data and initial config for Gluu Server persistence layer. |
...
| persistence.image.tag | string | `"4.5.15-1"` | Image  tag to use for deploying. |
...
| scim.image.tag | string | `"4.5.15-1"` | Image  tag to use for deploying. |
