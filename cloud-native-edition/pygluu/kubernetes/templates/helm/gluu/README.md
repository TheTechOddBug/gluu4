...
| config.configmap.gluuLicenseSsa | string | `"eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJuYW1lIjoiSm9obiBEb2UiLCJpYXQiOjE1MTYyMzkwMjJ9.BHX2DZGZDRwCOidg5KcNgjMFtAmaOujAAiJOGsIES4o"` | Gluu4 license SSA string (required); change the value to actual SSA string. |
...
| jackrabbit.image.tag | string | `"4.5.16_dev"` | Image  tag to use for deploying. |
