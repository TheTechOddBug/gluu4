...
### Casa added to installation script
For convenience, [Casa](https://gluu.org/docs/casa) can now be installed with the standard Community Edition setup script. See all the options in the [setup script documentation](./installation-guide/setup_py.md).
