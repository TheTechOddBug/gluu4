...
parser = argparse.ArgumentParser(description="This script creates crontab job for clearing Gluu Server tokens")
...
cron_file = '/etc/cron.d/gluu-session'
session_clean_file = '/opt/gluu/data-cleaner/clean-data-gluu.py'
