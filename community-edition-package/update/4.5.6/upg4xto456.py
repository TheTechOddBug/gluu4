...
up_version = "4.5.6"
maven_base = 'https://maven.gluu.org/maven4'
...
class GluuUpdater:
    def __init__(self):
        ...
        self.ces_dir = f'/install/{up_version}/community-edition-setup'
        ...
        self.gluu_archieve_fn = os.path.join(self.dist_gluu_folder, f'gluu-{up_version}')
    ...
    def download_ces(self):
        if argsp.offline:
            return
        self.download(
            f'https://github.com/GluuFederation/gluu4/archive/refs/tags/v{up_version}.zip',
            self.gluu_archieve_fn
            )

    def read_app_info(self):
        with zipfile.ZipFile(self.gluu_archieve_fn, "r") as py_zip:
            par_dir = py_zip.namelist()[0]
            app_info_fo = py_zip.open(os.path.join(par_dir, 'community-edition-setup/app_info.json'))
            self.app_info = json.load(app_info_fo)
    ...
    def download_apps(self):
        ...
        downloads = [
                    (maven_base + '/org/gluu/oxtrust-server/{0}{1}/oxtrust-server-{0}{1}.war'.format(up_version, self.app_info['OX_GITVERISON']), os.path.join(self.dist_gluu_folder, 'identity.war')),
                    (maven_base + '/org/gluu/oxauth-server/{0}{1}/oxauth-server-{0}{1}.war'.format(up_version, self.app_info['OX_GITVERISON']), os.path.join(self.dist_gluu_folder, 'oxauth.war')),
                    (maven_base + '/org/gluu/fido2-server/{0}{1}/fido2-server-{0}{1}.war'.format(up_version, self.app_info['OX_GITVERISON']), os.path.join(self.dist_gluu_folder, 'fido2.war')),
                    (maven_base + '/org/gluu/scim-server/{0}{1}/scim-server-{0}{1}.war'.format(up_version, self.app_info['OX_GITVERISON']), os.path.join(self.dist_gluu_folder, 'scim.war')),
                    ('https://repo1.maven.org/maven2/org/eclipse/jetty/jetty-home/{0}/jetty-home-{0}.tar.gz'.format(self.app_info['JETTY_VERSION']), os.path.join(self.dist_app_folder, 'jetty-home-{0}.tar.gz'.format(self.app_info['JETTY_VERSION']))),
                    ('https://corretto.aws/downloads/resources/{0}/amazon-corretto-{0}-linux-x64.tar.gz'.format(self.app_info['AMAZON_CORRETTO_VERSION']), os.path.join(self.dist_app_folder, 'amazon-corretto-{0}-linux-x64.tar.gz'.format(self.app_info['AMAZON_CORRETTO_VERSION']))),
                    (maven_base + '/org/gluufederation/jython-installer/{0}/jython-installer-{0}.jar'.format(self.app_info['JYTHON_VERSION']), os.path.join(self.dist_app_folder, 'jython-installer-{}.jar'.format(self.app_info['JYTHON_VERSION']))),
                    ('https://nodejs.org/dist/{0}/node-{0}-linux-x64.tar.xz'.format(self.app_info['NODE_VERSION']), os.path.join(self.dist_app_folder, 'node-{0}-linux-x64.tar.xz'.format(self.app_info['NODE_VERSION']))),
                    ...
                    (maven_base + '/org/gluufederation/opendj/opendj-server-legacy/{0}/opendj-server-legacy-{0}.zip'.format(self.app_info['OPENDJ_VERSION']), os.path.join(self.dist_app_folder, 'opendj-server-{}.zip'.format(self.app_info['OPENDJ_VERSION']))),
                    (maven_base + '/org/gluu/oxauth-client-jar-with-dependencies/{0}{1}/oxauth-client-jar-with-dependencies-{0}{1}.jar'.format(up_version, self.app_info['OX_GITVERISON']), os.path.join(self.dist_gluu_folder, 'oxauth-client-jar-with-dependencies.jar')),
                    ...
                    (maven_base + '/org/gluu/oxshibbolethIdp/{0}{1}/oxshibbolethIdp-{0}{1}.war'.format(up_version, self.app_info['OX_GITVERISON']), os.path.join(self.dist_gluu_folder, 'idp.war')),
                    (maven_base + '/org/gluu/oxShibbolethStatic/{0}{1}/oxShibbolethStatic-{0}{1}.jar'.format(up_version, self.app_info['OX_GITVERISON']), os.path.join(self.dist_gluu_folder, 'shibboleth-idp.jar')),
                    (maven_base + '/org/gluu/oxShibbolethKeyGenerator/{0}{1}/oxShibbolethKeyGenerator-{0}{1}.jar'.format(up_version, self.app_info['OX_GITVERISON']), os.path.join(self.dist_gluu_folder, 'idp3_cml_keygenerator.jar')),
                    ...
                    (maven_root + '/npm4/passport/passport-{}.tgz'.format(self.app_info['PASSPORT_VERSION']), os.path.join(self.dist_gluu_folder, 'passport.tgz')),
                    (maven_root + '/npm4/passport/passport-{}-node_modules.tar.gz'.format(self.app_info['PASSPORT_VERSION']), os.path.join(self.dist_gluu_folder, 'passport-version_{}-node_modules.tar.gz'.format(up_version))),
                    (maven_base + '/org/gluu/super-gluu-radius-server/{0}{1}/super-gluu-radius-server-{0}{1}-distribution.zip'.format(up_version, self.app_info['OX_GITVERISON']), os.path.join(self.dist_gluu_folder, 'gluu-radius-libs.zip')),
                    (maven_base + '/org/gluu/super-gluu-radius-server/{0}{1}/super-gluu-radius-server-{0}{1}.jar'.format(up_version, self.app_info['OX_GITVERISON']), os.path.join(self.dist_gluu_folder, 'super-gluu-radius-server.jar')),
                    (maven_base + '/org/gluu/oxd-server/{0}{1}/oxd-server-{0}{1}-distribution.zip'.format(up_version, self.app_info['OX_GITVERISON']), os.path.join(self.dist_gluu_folder, 'oxd-server-distribution.zip')),
                    (maven_base + '/org/gluu/casa/{0}{1}/casa-{0}{1}.war'.format(up_version, self.app_info['OX_GITVERISON']), os.path.join(self.dist_gluu_folder, 'casa.war')),
                    (maven_base + f'/org/gluu/scim-server/{up_version}/scim-server-{up_version}.war', os.path.join(self.dist_gluu_folder,'scim.war')),
                    (maven_base + '/org/gluu/gluu-orm-couchbase-libs/{0}{1}/gluu-orm-couchbase-libs-{0}{1}-distribution.zip'.format(up_version, self.app_info['OX_GITVERISON']), os.path.join(self.dist_gluu_folder, 'gluu-orm-couchbase-libs-distribution.zip')),
                    ]
        for p in self.casa_plugins:
            downloads.append((self.casa_plugins[p].format(up_version, self.app_info['OX_GITVERISON']), os.path.join(self.dist_gluu_folder, p + '.jar')))
    ...
    def unzip_ces(self):
        ...
        print(f"Extracting CES package to {self.ces_dir}")

        extract_subdir(
            self.gluu_archieve_fn,
            'community-edition-setup',
            os.path.dirname(self.ces_dir)
        )
    ...
    def prepare_ces(self):
        ...
        self.SetupProfiles = SetupProfiles
        ...
        self.gluuInstaller.createDirs(self.Config.outputFolder)
    ...
    def update_opendj(self):
        ...
        opendj_fn = os.path.join(self.dist_app_folder, 'opendj-server-{}.zip'.format(self.app_info['OPENDJ_VERSION']))
    ...
    def update_java(self):
        ...
        if os.path.isdir('/opt/amazon-corretto-{}-linux-x64'.format(self.app_info['AMAZON_CORRETTO_VERSION'])):
    ...
    def update_jython(self):
        ...
        if os.path.isdir('/opt/jython-{}'.format(self.app_info['JYTHON_VERSION'])):
        ...
        print("Installing Jython", self.app_info['JYTHON_VERSION'])
    ...
    def update_node(self):
        ...
        #check if jython is up to date
        if os.path.isdir('/opt/node-{}-linux-x64'.format(self.app_info['NODE_VERSION'])):
        ...
        print("Installing Node", self.app_info['NODE_VERSION'])
    ...
    def update_jetty(self):
        ...
        src_jdist = os.path.join(self.dist_app_folder, 'jetty-home-{0}.tar.gz'.format(self.app_info['JETTY_VERSION']))
        ...
        if os.path.isdir('/opt/jetty-10.0/jetty-home-{}'.format(self.app_info['JETTY_VERSION'])):
        ...
        print("Installing Jetty", self.app_info['JETTY_VERSION'])
    ...
    def update_oxd(self):
        ...
        self.update_unit_file(self.oxdInstaller.service_name)
    ...
    def update_casa(self):
        ...
        for casa_lib in glob.glob(os.path.join(pylib_dir, 'casa-external*.py')):
            ...
            self.casaInstaller.copyFile(
                os.path.join(self.ces_dir, 'static/casa/scripts', casa_lib_fn),
                pylib_dir
                )
        ...
        self.update_unit_file(self.casaInstaller.service_name)

    def update_unit_file(self, service_name):
        if self.Config.profile == self.SetupProfiles.DISA_STIG:
            self.Config.templateRenderingDict['service_user'] = service_name
        else:
            self.Config.templateRenderingDict['service_user'] = self.Config.jetty_user

        self.gluuInstaller.render_unit_file(service_name)
        self.gluuInstaller.run(['systemctl', 'daemon-reload'])
    ...
    def update_misc_config(self):
        if os.path.exists(self.Config.gluuCouchebaseProperties):
            couchbase_config_properties = read_prop(self.Config.gluuCouchebaseProperties)
            for prop in couchbase_config_properties:
                if 'connection.wait-until-ready-time' == prop:
                    break
            else:
                self.gluuInstaller.appendLine('connection.wait-until-ready-time: -1')
